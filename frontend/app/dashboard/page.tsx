...
const STAT_COLORS: Record<string, { bg: string; icon: string; badge: string }> = {
  ...
  sky:    { bg: "bg-slate-50",  icon: "bg-slate-900 text-white",  badge: "bg-slate-100 text-slate-800"  },
      ...
      <div>
        ...
        <nav className="mt-3 flex flex-col gap-0.5 px-2">
          ...
          <a
            ...
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-900 hover:bg-slate-50 hover:text-slate-900 transition-all duration-150 w-full mt-1 border border-slate-200"
          >
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="mt-0.5 text-sm text-blue-100">
                  Here&apos;s what&apos;s happening at Aalgorix World Academy today.
                </p>
              </div>

...
const Programs = () => {
  return (
    <div className="min-h-screen bg-[#0A1428] text-white">
      {/* Navbar */}
      <nav className="fixed top-0 w-full bg-[#0A1428]/95 backdrop-blur-md z-50 border-b border-slate-900">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-slate-900 rounded-xl flex items-center justify-center text-2xl font-bold">A</div>
            <h1 className="text-2xl font-bold tracking-tight">Aalgorix World Academy</h1>
          </div>

          <div className="hidden md:flex items-center gap-8 text-lg">
            <Link href="/" className="hover:text-slate-200 transition">Home</Link>
            <Link href="/about" className="hover:text-slate-200 transition">About Us</Link>
            <Link href="/programs" className="text-slate-200 font-semibold">Programs</Link>
            <Link href="/admissions" className="hover:text-slate-200 transition">Admissions</Link>
            <Link href="/contact" className="hover:text-slate-200 transition">Contact Us</Link>
          </div>

          <Link 
            href="/admissions" 
            className="bg-slate-900 hover:bg-slate-800 px-6 py-3 rounded-xl font-semibold transition"
          >
            Enroll Now
          </Link>
        </div>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-[#0A1428] to-[#11223d] text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="#hybrid-school" 
              className="bg-slate-900 hover:bg-slate-800 px-10 py-4 rounded-2xl text-lg font-semibold transition"
            >
              Explore Hybrid School
            </Link>
            <Link 
              href="/upskilling" 
              className="border border-slate-700 hover:bg-slate-900/10 px-10 py-4 rounded-2xl text-lg font-semibold transition"
            >
              Browse Upskilling
            </Link>
          </div>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div id="hybrid-school" className="bg-[#11223d] rounded-3xl p-10 hover:scale-105 transition-all duration-300 group">
            <div className="text-slate-200 text-5xl mb-6">🏫</div>
            ...
            <Link 
              ...
              className="inline-block bg-slate-900 hover:bg-slate-800 px-8 py-3.5 rounded-2xl font-semibold transition group-hover:scale-105"
            >
              Learn More →
            </Link>
          </div>
      ...
      <section className="py-20 bg-slate-900 text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-xl mb-10">Join Aalgorix World Academy and give your child the perfect blend of academics and future skills.</p>
          <Link 
            href="/admissions" 
